package com.web.captureNow.controller;
...
public class CustomerController {
	...
	ResponseEntity<Customer> customerLogin(@RequestHeader String email,@RequestHeader String password)
	{
		return new ResponseEntity<Customer>(service.customerLog(email, password), HttpStatus.FOUND);
	}
}
